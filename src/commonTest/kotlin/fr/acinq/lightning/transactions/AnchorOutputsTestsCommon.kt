...
import fr.acinq.lightning.crypto.FromHexPrivateKeyDescriptor
...
class AnchorOutputsTestsCommon {
    val local_funding_privkey = FromHexPrivateKeyDescriptor("30ff4956bbdd3222d44cc5e8a1261dab1e07957bdac5ae88fe3261ef321f374901")
    ...
    val remote_funding_privkey = FromHexPrivateKeyDescriptor("1552dfba4f6cf29a62a0af13c8d6981d36d0ef8d61ba10fb0fe90da7634d7e1301")
    val local_payment_basepoint_secret = FromHexPrivateKeyDescriptor("111111111111111111111111111111111111111111111111111111111111111101")
    ...
    val local_delayed_payment_basepoint_secret = FromHexPrivateKeyDescriptor("333333333333333333333333333333333333333333333333333333333333333301")
    val remote_payment_basepoint_secret = FromHexPrivateKeyDescriptor("444444444444444444444444444444444444444444444444444444444444444401")
