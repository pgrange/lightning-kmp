...
import fr.acinq.lightning.crypto.FromByteArrayPrivateKeyDescriptor
import fr.acinq.lightning.crypto.FromBytes32PrivateKeyDescriptor
...
class TransactionsTestsCommon : LightningTestSuite() {
    ...
    private val localFundingPriv = FromBytes32PrivateKeyDescriptor(randomBytes32())
    private val remoteFundingPriv = FromBytes32PrivateKeyDescriptor(randomBytes32())
    private val localRevocationPriv = FromBytes32PrivateKeyDescriptor(randomBytes32())
    private val localPaymentPriv = FromBytes32PrivateKeyDescriptor(randomBytes32())
    private val localDelayedPaymentPriv = FromBytes32PrivateKeyDescriptor(randomBytes32())
    private val remotePaymentPriv = FromBytes32PrivateKeyDescriptor(randomBytes32())
    private val localHtlcPriv = FromBytes32PrivateKeyDescriptor(randomBytes32())
    private val remoteHtlcPriv = FromBytes32PrivateKeyDescriptor(randomBytes32())
...
//            val localSig = sign2(claimP2WPKHOutputTx.result, remotePaymentPriv, remotePaymentPrivDescriptor)
    ...
    fun `spend 2-of-2 swap-in taproot-musig2 version`() {
        val userPrivateKey = FromByteArrayPrivateKeyDescriptor(ByteArray(32) { 1 })
        val serverPrivateKey = FromByteArrayPrivateKeyDescriptor(ByteArray(32) { 2 })
        ...
        val masterPrivateKeyDescriptor = LocalKeyManager.ActualExtendedPrivateKeyDescriptor(masterPrivateKey)
